...
export default function About() {
  return (
    <>
    <h1>About</h1>
    <h2>Virginia Wolf – Death of A Moth</h2>
    <div className="text-wrapper">
    Moths that fly by day are not properly to be called moths; they do not excite that
pleasant sense of dark autumn nights and ivy-blossom which the commonest yellow-underwing asleep in the shadow of the curtain never fails to rouse in us.
...
than that of the summer months. The plough was already scoring the field opposite the window, and where the share had been, the earth was pressed flat and
...
was, indeed, conscious of a queer feeling of pity for him. The possibilities of pleasure seemed that morning so enormous and so various that to have only a moth’s
part in life, and a day moth’s at that, appeared a hard fate, and his zest in enjoying his meager opportunities to the full, pathetic. He flew vigorously to one corner of his compartment, and, after waiting there a second, flew across to the
...
out at sea. What he could do he did. Watching him, it seemed as if a fiber, very thin but pure, of the enormous energy of the world had been thrust into his frail
...
other matters I watched these futile attempts for a time without thinking, unconsciously waiting for him to resume his flight, as one waits for a machine, that has
stopped momentarily, to start again without considering the reason of its failure.
After perhaps a seventh attempt he slipped from the wooden ledge and fell, fluttering his wings, on to his back on the windowsill. The helplessness of his attitude
...
which he struggled. I looked out of doors. What had happened there? Presumably it was midday, and work in the fields had stopped. Stillness and quiet had replaced the previous animation. The birds had taken themselves off to feed in the
brooks. The horses stood still. Yet the power was there all the same, massed outside, indifferent, impersonal, not attending to anything in particular. Somehow it
...
bead. I lifted the pencil again, useless though I knew it to be. But even as I did so, the unmistakable tokens of death showed themselves. The body relaxed, and instantly grew stiff. The struggle was over. The insignificant little creature now
